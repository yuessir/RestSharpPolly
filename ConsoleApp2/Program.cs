...
namespace ConsoleApp2
{
    ...
    internal static class Program
    {
        ...
        private static async Task Main(string[] args)
        {
            ...
            var client2Async = RestClientFactory<IRestResponse<QueryResultModel>>.Create(noResultaAyncPolicyT);
            client2Async.BaseUrl = new Uri("https://httpstat.us/500");
            IRestRequest request3 = new RestRequest(Method.GET);
            //if runtime have errors ,it will retry.
            var response2 = await client2Async.ExecuteAsync<QueryResultModel>(request3);
            Console.ReadKey();
